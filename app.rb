...
#   def initialize(book_list, person_list)
#     @rentals = []
#     @book_list = book_list
...
#   def create_rental
#     puts 'Select a book from the following list by number:'
#     @book_list.books.each_with_index do |book, index|
#       puts "#{index}) Title: #{book.title}, Author: #{book.author}"
#     end
#     book = gets.chomp.to_i

#     puts 'Select a person from the following list by number (not id):'
#     @person_list.people.each_with_index do |person, index|
#       puts "#{index}) [#{person.class.name}] Name: #{person.name}, ID: #{person.id}, Age: #{person.age}"
#     end
#     person = gets.chomp.to_i
...
#     rental = Rental.new(date, @book_list.books[book], @person_list.people[person])
#     @rentals.push(rental)
#     puts 'Rental created successfully'
#   end
